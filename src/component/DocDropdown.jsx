...
const DocDropdown = (props) => {
  ...
  return (
    <div ref={ref}>
      <div class="dropdown-menu f-r show" aria-labelledby="metaDrop">
        <Formik enableReinitialize initialValues={{ metaFiled: initialValues }}>
                      ...
                      return (
                        <div key={index}>
                          <Checkbox
                            ...
                            disabled={
                              values.metaFiled.filter((item) => item === true)
                                .length === 1 && values.metaFiled[index]
                            }
                            onChange={(value) => {
